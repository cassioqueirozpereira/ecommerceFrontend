...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const baseStyles = "inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blush disabled:opacity-50 disabled:pointer-events-none";
    
    const variants = {
      primary: "bg-obsidian text-ivory hover:bg-graphite",
      secondary: "bg-blush text-obsidian hover:bg-blush-dark",
